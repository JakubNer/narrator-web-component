...
(defn start-replay [this]
  (.log js/console "start-progress-bar")
  (when-let [replay (dom/sel1 (str "#replay-" (instance-id this)))]
    (dom/remove-style! replay :animation)
    (js/setTimeout #(dom/set-style! replay :animation (str "narration-progress " (:seconds (:flow @(current this))) "s linear")) 100)))
...
(defn toggle [this]
  (set-keyframe this @(keyframe this)))
  ...
  (let [number-sections (- (count @(narration this)) 1)]
    [:div.narrator-buttons {:id (str "narrator-buttons-" (instance-id this))}
     [:div {:style {:width "104px"
                    ...
                    :opacity (if (< 0 @(keyframe this)) 1 0.4)
                    :border-radius "12px 0px 0px 12px"
                    :max-height 64
                    :cursor (if (< 0 @(keyframe this)) :pointer :default)}
            :on-click #(do (when (playing? this) (pause this))
                           (when (< 0 @(keyframe this)) (goto-previous this)))}
      [:img.narrator-button
       {:style {:max-height 64}
   ...
   "
     ...
     [:div {:style {:border-top "2px solid black"
                    ...
                    :max-height 64
                    :height 64
                    :background-color (when (playing? this) "#FFD7B2")}
            :on-click #(if (playing? this) (pause this) (play this))}
      (if (playing? this)
        [:img.narrator-button
     ...
     [:div {:style {:border-top "2px solid black"
                    ...
                    :border-right "2px solid black"
                    :max-height 64
                    :cursor (if (= (:seconds (:flow @(current this))) 0) :default :pointer)}
            :on-click #(when (> (:seconds (:flow @(current this))) 0) (toggle this))}
      [:img.narrator-button
        {:id (str "replay-" (instance-id this))
         :style {:max-height "64px"
                :opacity (if (= (:seconds (:flow @(current this))) 0) 0.4 1)}
     ...
     [:div {:style {:width "15em"
                    :max-height 64
                    :font-size "24px"
                    :background-color (if (and (> number-sections @(keyframe this)) (not (playing? this))) "#B2FFD7" "white")
                    :opacity (if (> number-sections @(keyframe this)) 1 0.4)
                    :border-top "2px solid black"
                    :border-bottom "2px solid black"
                    :border-right "2px solid black"
                    ...
                    :cursor (if (> number-sections @(keyframe this)) :pointer :default)}
            :on-click #(do (when (playing? this) (pause this))
                           (when (> number-sections @(keyframe this)) (goto-next this)))}
      [:img.narrator-button
       {:style {:max-height 64
                :margin-right "0px"}
      ...
      [:span {:style {:flex-grow 10
                      ...
                      :max-height "48px"
                      :overflow :hidden}} 
        [:span {:id "next-button-label"} "NEXT SLIDE"]
        (when @(next-hint this) 
...
(defn render [this narrator-attrs]
  ...
  (let [sections @(get narrator-attrs "sections")
        ...
        hint @(get narrator-attrs "next-hint")
